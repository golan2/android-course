...
public class RoundThermometer extends View {
	// drawing tools
	...
	public RoundThermometer(Context context) {
		super(context);
		init();
	}

	public RoundThermometer(Context context, AttributeSet attrs) {
		super(context, attrs);
		init();
	}

	public RoundThermometer(Context context, AttributeSet attrs, int defStyle) {
	...
	public void SetTemperature(float temperature){
		...
		float temperatureF = (9.0f / 5.0f) * temperature + 32.0f;
